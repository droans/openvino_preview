...
KeepMOE3GemmConstPrecision::KeepMOE3GemmConstPrecision() {
    ...
    // New input layout (after routing split):
    // [hs, topk_weights, w0, s0, zp0, w1, s1, zp1, w2, s2, zp2, topk_indices, (shared...)?]
    ...
    // Without shared expert: 12 inputs
    auto moe_no_shared_m = wrap_type<ov::intel_gpu::op::MOE3GemmFusedCompressed>(
    ...
    auto moe_shared_m = wrap_type<ov::intel_gpu::op::MOE3GemmFusedCompressed>(
        {any_input(), any_input(), wei_0_m, any_input(), zp_0_m, wei_1_m, any_input(), zp_1_m, wei_2_m, any_input(),
         zp_2_m, any_input(), sh_gate_wei_m, any_input(), sh_gate_zp_m, sh_up_wei_m, any_input(), sh_up_zp_m, sh_down_wei_m, any_input(), sh_down_zp_m, any_input()});
